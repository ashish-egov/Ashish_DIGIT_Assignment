...
@NoArgsConstructor
@Builder
public class DeathRegistrationResponseSearch   {
    @JsonProperty("ResponseInfo")
    private ResponseInfo responseInfo = null;

    @JsonProperty("DeathRegistrationApplications")
    @Valid
    private List<DeathRegistrationApplicationSearch> deathRegistrationApplications = null;


    public DeathRegistrationResponseSearch addDeathRegistrationApplicationsItem(DeathRegistrationApplicationSearch deathRegistrationApplicationsItem) {
